...
class Trainer:
    ...
    def BCELoss(self, seq_output, pos_ids, neg_ids):
        '''
        ...
        if mode == "train":
            ...
            for epoch in range(self.max_epochs):
                ...
                for i, id_tensors in iter_data:
                    ...
                    seq_output = self.model((uid, input_item, input_bs, target_bs)) # (EMP, IMP)
                    bce_loss = self.BCELoss(seq_output, target_item, target_neg)
